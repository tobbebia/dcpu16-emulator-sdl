...
#define LEM1802_INC_INT_MEM_MAP_SCREEN		0
#define LEM1802_INC_INT_MEM_MAP_FONT		1
#define LEM1802_INC_INT_MEM_MAP_PALETTE		2
#define LEM1802_INC_INT_SET_BORDER_COLOR	3
#define LEM1802_INC_INT_MEM_DUMP_FONT		4
#define LEM1802_INC_INT_MEM_DUMP_PALETTE	5

#define LEM1802_DEFAULT_BORDER_COLOR		1
